                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                Criado por <span class="font-medium">{{ $ticket->cliente->name }}</span> •
                                {{ $ticket->created_at->format('d M Y H:i') }}
                            </p>
                        </div>
                        <div class="flex space-x-2">
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">
                                {{ $ticket->tipo->nome ?? 'Ticket' }}
                            </span>
                        </div>
                    </div>
                                ...
                                <div class="flex items-center justify-between mb-2">
                                    <div class="flex items-center space-x-2">
                                        <div class="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center text-white font-semibold text-sm">
                                            {{ substr($mensagem->user->name, 0, 1) }}
                                        </div>
                                        <div>
                                            <span class="font-medium text-gray-900">{{ $mensagem->user->name }}</span>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div>
                            ...
                            <span class="font-medium">{{ $ticket->cliente->name }}</span>
                        </div>
                    ...
                    <div class="space-y-3">
                        @forelse($ticket->logs->take(5) as $log)
                            <div class="text-xs border-l-2 border-gray-200 pl-3">
                                <div class="text-gray-900 font-medium">{{ $log->user->name }}</div>
